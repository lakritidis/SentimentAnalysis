...
class TextPreprocessor:
    ...
    # Receives a raw un-formatted text and strips punctuation, numbers, and whitespaces. Then, it tokenizes each input
    ...
    def preprocess_wordlist(self, text):
        ...
        words = [w for w in word if not w in self.stopwords_]
